...
# We will just rewrite the whole endpoint again cleanly, because writing regex for this is painful.
import subprocess
    ...
    async def generate_chat_stream():
        ...
        async for msg, metadata in graph.astream({"messages": messages}, stream_mode="messages"):
            ...
            if msg.type == "ai" and msg.content and isinstance(msg.content, str):
                ...
                cmd_dict = {"content": msg.content}
                yield f"data: {json.dumps(cmd_dict)}\n\n"
